...
"""Authentication blueprint for API v2 login and auth endpoints."""
...
# v2 Authentication Blueprint - URL prefix will be set during registration
auth_bp_v2 = Blueprint('auth_v2', __name__, template_folder='templates')
...
@auth_bp_v2.route('/auth', methods=['GET'])
@disk_space_check
def auth():
